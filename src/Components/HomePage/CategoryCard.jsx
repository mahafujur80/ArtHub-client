  ...
  return (
    <motion.div variants={variants}>
      <Link href={category.link}>
        <div className="relative h-30 md:h-52 rounded-2xl overflow-hidden cursor-pointer group shadow-lg hover:shadow-2xl transition-all duration-300">
          {/* Background Image */}
          <div
          ...
          <div className="relative h-full flex flex-col justify-end p-4 md:p-5">
            <h3 className="text-white text-[11px] md:text-xl font-bold tracking-wide">
              {category?.name}
            </h3>
