...
const ManageArt = async ({searchParams}) => {
    ...
    return (
        <div className='p-5'>
            <div className="mb-6">
                <h1 className="text-2xl md:text-3xl font-bold text-gray-900">Manage My Artworks</h1>
                <p className="text-gray-500 mt-2">View, edit, or delete your published artworks.</p>
            </div>
